...
public final class SequenceSmoothTest {
    ...
    /**
     * Test smooth with s1 = <-10,-8,-6,-4,-2> and s2 = <1, 2, 3>.
     */
    @Test
    public void test3() {
        /*
    ...
    /**
     * Test smooth with s1 = <9,10,11,12> and s2 = <1, 2, 3>.
     */
    @Test
    public void test4() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(9, 10, 11, 12);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(9, 10, 11, 12);
        Sequence<Integer> seq2 = this.createFromArgs(1, 2, 3);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(9, 10, 11);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
    ...
    /**
     * Test smooth with s1 = <-10,-4,0,4,10> and s2 = <1, 2, 3>.
     */
    @Test
    public void test5() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(-10, -4, 0, 4, 10);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(-10, -4, 0, 4, 10);
        Sequence<Integer> seq2 = this.createFromArgs(1, 2, 3);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(-7, -2, 2, 7);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
    ...
    /**
     * Test smooth with s1 = <-5,8,-6,7,6,-10> and s2 = <1, 2, 3>.
     */
    @Test
    public void test6() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(-5, 8, -6, 7, 6, -10);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(-5, 8, -6, 7, 6,
                -10);
        Sequence<Integer> seq2 = this.createFromArgs(1, 2, 3);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(1, 1, 0, 6, -2);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
    ...
    /**
     * Test smooth with s1 = <10,8,6,4> and s2 = <1, 2, 3>.
     */
    @Test
    public void test7() {
        /*
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(10, 8, 6, 4);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(10, 8, 6, 4);
        Sequence<Integer> seq2 = this.createFromArgs(1, 2, 3);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(9, 7, 5);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
