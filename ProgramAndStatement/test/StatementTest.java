...
public abstract class StatementTest {
     ...
     * The name of a file containing a sequence of BL statements.
     */
    private static final String FILE_KUN = "data/statement-kun.bl";
     ...
     */
    @Test
    public final void testAddToBlockExterior1() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_NAME_1);
     ...
     */
    @Test
    public final void testAddToBlockExterior2() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_NAME_1);
    ...
    /**
     * Test removeFromBlock from interior leaving a non-empty block behind.
     */
    @Test
    public final void testRemoveFromInteriorLeavingNonEmpty() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_NAME_1);
    ...
    /**
     * Test removeFromBlock leaving an empty block.
     */
    @Test
    public final void testRemoveFromBlockLeavingEmpty() {
         ...
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_KUN);
        Statement sRef = this.createFromFileRef(FILE_KUN);
        Statement nestedRef = sRef.removeFromBlock(0);
