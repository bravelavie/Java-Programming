...
public abstract class ProgramTest {
     ...
     * The name of a file containing a BL program.
     */
    private static final String FILE_KUN = "data/program-kun.bl";
     ...
     */
    @Test
    public final void testReplaceNameKun() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_KUN);
        Program pRef = this.createFromFileRef(FILE_KUN);
        String newName = "Replacement";
        String nameRef = pRef.replaceName(newName);
     ...
     */
    @Test
    public final void testNewContextKun() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_KUN);
     ...
     */
    @Test
    public final void testReplaceContextKun() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_KUN);
     ...
     */
    @Test
    public final void testNewBodyKun() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_KUN);
     ...
     */
    @Test
    public final void testReplaceBodyKun() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_KUN);
