...
public abstract class MapTest {
    ...
    public final void testRemoveAny1() {
        ...
        Map<String, String> m = this.createFromArgsTest("1", "abc", "2", "def",
                "3", "ghi");
        Map<String, String> mExpected1 = this.createFromArgsRef("1", "abc",
                "2", "def");
        Map<String, String> mExpected2 = this.createFromArgsRef("1", "abc",
                "3", "ghi");
        Map<String, String> mExpected3 = this.createFromArgsRef("3", "ghi",
                "2", "def");
